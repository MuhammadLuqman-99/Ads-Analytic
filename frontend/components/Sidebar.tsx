...
const navigation = [
  ...
  { name: 'Platforms', href: '/platforms', icon: CloudIcon },
                ...
                {navigation.map((item) => (
                  <li key={item.name}>
                    ...
                    >
                      <item.icon
                        className={classNames(
                          pathname === item.href ? 'text-indigo-400' : 'text-slate-500 group-hover:text-indigo-400',
            ...
            <li className="mt-auto">
              <div className="rounded-lg bg-slate-800/50 p-4 border border-slate-700/50">
                ...
                <div className="mt-2 flex gap-2">
                  ...
                  <div className="h-8 w-8 rounded-full bg-black flex items-center justify-center text-xs text-white font-medium">
                    T
                  </div>
                  <div className="h-8 w-8 rounded-full bg-orange-500 flex items-center justify-center text-xs text-white font-medium">
                    S
                  </div>
                </div>
              </div>
